...
@ActorPrototype(
        {MovementControllerComponent.class, CombatControllerComponent.class, StatsControllerComponent.class, StatusControllerComponent.class, InventoryControllerComponent.class,
                PlayerKnownListRangeComponent.class})
public abstract class CharacterObject extends BaseObject implements CharacterObjectView {
}
